	...
	<div class="well np">
		<div id="myCarousel" class="carousel slide homCar">
            <div class="carousel-inner">
			  <div class="item">
                <img style="width:100%" src="<?php echo base_url();?>assets/gambar/bg laptop.png" alt="bootstrap ecommerce templates">
                <div class="carousel-caption">
                      <h4>ASUS</h4><br></br><br></br>
...
<div class="well well-small">
<h3><a class="btn btn-mini pull-right"></a>Produk Unggulan</h3>
      <hr class="soften"/>
      <div class="row-fluid">
      <ul class="thumbnails">
      <li class="span4">
